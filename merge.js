...
const mergePDF = async (p1, p2) => {
  ...
  await merger.add(p1); // Specify the path to the first PDF
  await merger.add(p2); // Specify the path to the second PDF

  await merger.save('public/merged.pdf'); // Save the merged PDF
